...
function toDoApp(state, action) {
    ...
    var newToDoList = Object.assign([], state.toDoList);
    var newState = Object.assign({}, { filter: state.filter, toDoList: newToDoList });
    var doActionByType = {
        ADD_TODO: function ADD_TODO() {
            newState.toDoList.push({ done: false, value: "" });
            return newState;
        },
        TOGGLE_TODO: function TOGGLE_TODO() {
...
function input(index, text) {
    return { type: "INPUT", index: index, text: text };
}
exports.input = input;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(24);
...
var ToDoListRaw = function (_super) {
    __extends(ToDoListRaw, _super);
    function ToDoListRaw(props) {
        return _super.call(this, props) || this;
    }
    ToDoListRaw.prototype.render = function () {
        var toDoList = this.toDoList();
        return React.createElement("div", null, React.createElement("h1", null, "ToDo list:"), toDoList, React.createElement("br", null), React.createElement("button", { type: "button", onClick: this.props.addTodo }, "Add new item"), React.createElement("label", null, React.createElement("input", { type: "checkbox", onChange: this.toggleFilter.bind(this) }), "Hide done items"));
    };
    ToDoListRaw.prototype.toggleFilter = function (ev) {
        var filter = ev.target.checked ? "SHOW_UNDONE" : "SHOW_ALL";
        this.props.setVisibilityFilter(filter);
    };
    ToDoListRaw.prototype.handleToDoInputChange = function (index, ev) {
        var newValue = ev.target.value;
        this.props.input(index, newValue);
    };
    ToDoListRaw.prototype.toDoList = function () {
        var _this = this;
        var toDoList = this.props.toDoList.map(function (item, index) {
            return React.createElement("tr", { key: index }, React.createElement("td", null, React.createElement("input", { type: "checkbox", onChange: _this.props.toggleTodo.bind(_this, index), checked: item.done })), React.createElement("td", null, React.createElement("input", { type: "text", value: item.value, onChange: _this.handleToDoInputChange.bind(_this, index) })));
        });
        var toDoListFiltered = toDoList.filter(function (item, index) {
            return _this.props.filter === "SHOW_ALL" || !_this.props.toDoList[index].done;
        });
...
var mapDispatchToProps = { addTodo: reducers_1.addTodo, input: reducers_1.input, setVisibilityFilter: reducers_1.setVisibilityFilter, toggleTodo: reducers_1.toggleTodo };
// connect redux store with react component
var ToDoList = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(ToDoListRaw);
...
var toDoList_1 = __webpack_require__(21);
var reducers_1 = __webpack_require__(6);
var store = redux_1.createStore(reducers_1.default);
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store }, React.createElement(toDoList_1.default, null)), document.getElementById("root"));
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(43);
